...
genomelink_attributes = ['agreeableness','alcohol-drinking-behavior','anger','beard-thickness','bitter-taste','black-hair','blood-glucose','caffeine-consumption','calcium','carbohydrate-intake','childhood-intelligence','conscientiousness','depression','egg-allergy','endurance-performance','excessive-daytime-sleepiness','extraversion','freckles','gambling','eye-color','harm-avoidance','hearing-function','height','intelligence','iron','job-related-exhaustion','lobe-size','longevity','mathematical-ability','milk-allergy','morning-person','motion-sickness','neuroticism','novelty-seeking','openness','reading-and-spelling-ability','red-hair','red-wine-liking','reward-dependence','smoking-behavior','white-wine-liking']
